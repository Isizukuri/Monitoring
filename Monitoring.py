...
SearchWord=raw_input('Enter key word: ')
StartDate = raw_input('Enter start of search period: ')
EndDate = raw_input('Enter start of search period: ')
...
SoupAdjudication=BeautifulSoup((requests.get(CourtLink)).text)


print Adjudication.get_text()
